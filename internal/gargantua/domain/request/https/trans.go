...
func TransRequestContentFromPb(request *protobuf.HttpsRequest) *RequestContent {
...
func TransResponseContentFromPb(response *protobuf.HttpsResponse) *ResponseContent {
